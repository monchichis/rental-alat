<body>
    <div class="ui inverted vertical masthead segment" id="first-segment">
        ...
        <div class="ui first coupled small modal">
            ...
            <div class="content">
                <form class="ui form" id="tn-login-form" action="<?php echo e(url('native/login')); ?>" method="post">
    ...
    </div><?php /**PATH /home/kwrnya/UTS/resources/views/part/index.blade.php ENDPATH**/ ?>